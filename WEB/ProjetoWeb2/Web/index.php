	...
	<body>
				...
				<?php
					...
					if (($alerta[0] == 0) & ($alerta[1] == 0)) {
						echo '<div class="alert alert-info" role="alert">
								<strong>Normal.</strong> Sem riscos de inundação!
									</div> ';
					} else if (($alerta[0] == 1) | (($alerta[1] == 1))) {
						echo '<div class="alert alert-warning" role="alert">
								<strong>Aviso!</strong> Alerta de inundação!
									</div> ';
					} else if ($alerta[0] == 2) {
						echo '<div class="alert alert-danger" role="alert">
								<strong>Perigo!</strong> Estado de inundação!
									</div> ';
					}
		...
		<div id="painelInfo" class="hidden-xs hidden-sm">
			...
			<?php				
				...
				if (($alerta[0] == 0) & ($alerta[1] == 0)) {
					echo '<div id="labelAlerta" class="alert alert-info" role="alert">
							<strong>Normal.</strong> Sem riscos de inundação!
								</div> ';
				} else if (($alerta[0] == 1) | (($alerta[1] == 1))) {
					echo '<div id="labelAlerta" class="alert alert-warning" role="alert">
							<strong>Aviso!</strong> Alerta de inundação!
								</div> ';
				} else if ($alerta[0] == 2) {
					echo '<div id="labelAlerta" class="alert alert-danger" role="alert">
							<strong>Perigo!</strong> Estado de inundação!
								</div> ';
				}
		...
		<!-- JQuery -->
		<script src="./Comum/js/geral/jquery.min.js"></script>
